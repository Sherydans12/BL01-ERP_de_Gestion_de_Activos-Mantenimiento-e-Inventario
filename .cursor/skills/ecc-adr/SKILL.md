...
name: ecc-adr
description: >-
  Registrar decisiones de arquitectura como ADRs (docs/adr/) o notas en docs/agentes/decisiones.md.
  Complementa el flujo de memoria del proyecto; no crea carpetas sin confirmación del usuario.
---

## BL01 — prioridad

1. **Notas ligeras:** `docs/agentes/decisiones.md` (ya existe).
2. **ADRs numerados (opcional):** `docs/adr/` según el flujo de abajo; crear la carpeta solo con confirmación explícita.
3. Reglas de producto y código: **`.cursor/rules/tpm-arquitectura.mdc`** no se negocian desde un ADR sin revisión humana.

Índice de repos: `docs/agentes/repos-externos.md`.
...
_Origen: skill `architecture-decision-records` en [everything-claude-code](https://github.com/affaan-m/everything-claude-code) (adaptada a BL01)._
