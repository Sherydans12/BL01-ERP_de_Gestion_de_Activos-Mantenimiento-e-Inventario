...
description: >-
  Analizar el codebase TPM (Angular 18, Nest 11, Prisma) y generar guía de onboarding.
  En BL01 la salida "tipo CLAUDE.md" debe alinearse con AGENTS.md y docs/agentes/, no duplicar el README.
---

## BL01 — mapeo esperado

- **Contexto canónico:** `AGENTS.md`, `README.md`, `docs/agentes/`, `.cursor/rules/tpm-arquitectura.mdc`.
- **Salida "Starter CLAUDE.md" del flujo ECC:** preferir **actualizar `AGENTS.md`** o `docs/agentes/README.md` (secciones cortas: entrypoints, comandos, mapa de carpetas), solo con confirmación del usuario. No inventar `CLAUDE.md` salvo que lo pidan explícitamente.
- **Stack real:** `frontend/` (Angular), `backend/` (Nest + Prisma), `docker-compose`, `DEPLOY-COOLIFY.md`.
...
_Origen: skill `codebase-onboarding` en [everything-claude-code](https://github.com/affaan-m/everything-claude-code) (adaptada a BL01 / AGENTS.md)._
