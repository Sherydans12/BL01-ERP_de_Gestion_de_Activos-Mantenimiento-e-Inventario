...
const BASE_COLUMNS: MasterExportColumn[] = [
  {
    ...
    key: 'id',
    width: 38,
    note: 'UUID del articulo. Mantener para futuras importaciones controladas.',
  },
  {
    header: 'Codigo inventario',
    key: 'inventoryCode',
    width: 16,
    note: 'SKU interno ERP. Normalmente lo asigna el sistema.',
  },
  ...
  { header: 'Permite decimales', key: 'allowsDecimals', width: 18 },
...
const COST_COLUMNS: MasterExportColumn[] = [
  ...
  { header: 'Valor linea', key: 'lineValue', width: 16, numFmt: '$#,##0.00' },
];
