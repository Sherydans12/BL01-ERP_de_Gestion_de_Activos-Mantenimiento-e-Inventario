...
- `Numero parte` se compara preservando espacios y signos relevantes; no se debe colapsar `Nuto H 68` con `NUTO H68` porque pueden representar articulos distintos.
